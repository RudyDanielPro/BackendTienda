...
public class ProductoController {
    ...
    public ResponseEntity<?> crearProducto(@RequestBody Map<String, Object> payload) {
        try {
            ...
            return new ResponseEntity<>(Map.of("error", "Error al crear: " + e.getMessage()),
    ...
    public ResponseEntity<?> notificarCompra(@RequestBody List<Map<String, Object>> carrito) {
        try {
            ...
            for (Map<String, Object> item : carrito) {
                ...
                String linkDeduccion = baseUrl + "/api/admin/productos/descontar-stock?productoId=" + idProd + "&talla="
                        + tallaEncoded + "&cantidad=" + cantidad;
                ...
                links.append("<div style='margin-bottom: 15px; border-bottom: 1px solid #eee; padding-bottom: 10px;'>")
                        ...
                        .append("<a href='").append(linkDeduccion)
                        .append("' style='background-color: #d9534f; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px; font-weight: bold;'>")
            ...
            e.printStackTrace();
            return new ResponseEntity<>(Map.of("error", "Error al procesar la notificación: " + e.getMessage()),
                    HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
        ...
        if (optProd.isPresent()) {
            ...
            if (modificado) {
                ...
                return ResponseEntity.badRequest()
                        .body("<html><body><h1>❌ Error: Talla no encontrada</h1></body></html>");
            }
        }
